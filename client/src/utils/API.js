...
export default {
  ...
  createUser: function (userInfo) {
    if (DebugOn) console.log ("In createUser before axios.post ", userInfo)
    return axios.post("/api/dbase/user/", userInfo);
  },
 
  // Updates user information in the database
  updateUser: function (id, userInfo) {
    if (DebugOn) console.log ("In updateUser before axios.put id:" + id, userInfo)
  ...
  //   if (DebugOn) console.log ("In updateDeviceById before axios.put " + id, updateInfo);
  ...
  findUser: function (userInfo) {
    if (DebugOn) console.log ("In findUser before axios.get ", userInfo);
  ...
  findUserById: function (id) {
    if (DebugOn) console.log ("In findUserById before axios.get " + id);
  ...
  removeUser: function (id, userInfo) {
    if (DebugOn) console.log ("In deleteUser before axios.delete id:" + id, userInfo);
    return axios.delete("/api/dbase/user/" + id, userInfo);
  },
  
  // Create/Save a new Device 
  createDevice: function (deviceInfo) {
    if (DebugOn) console.log ("In createDevice before axios.post ", deviceInfo);
  ...
  findAllOnlineDevices: function () {
    if (DebugOn) console.log ("In findAllOnlineDevices before axios.get ");
    return axios.get("/api/dbase/device/")
  }
};
